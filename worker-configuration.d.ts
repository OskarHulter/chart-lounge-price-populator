/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6370f2de3b25358e13e0d0da3c7fcee7)
// Runtime types generated with workerd@1.20250924.0 2025-09-27 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		ALPHA_VANTAGE_ACCESS_KEY: string;
		ALPHA_VANTAGE_BASE_URL: string;
		DEV_PORT: string;
		POPULATE_PRICE_HISTORY: Workflow;
	}
}
